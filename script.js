document.addEventListener('DOMContentLoaded', () => {
    ...
    const lyrics = [
        { time: 0, text: "....." },
        { time: 5, text: "Hi dedek" },
        { time: 8, text: "Aku minta maaf ya dedek belom bisa bikin dedek bahagia" },
        { time: 10, text: "Aku minta maaf juga ya karna aku kebanyakan sering ngeluh sama dedek" },
        { time: 16, text: "Dan aku juga mau ngucapin terima kasih sama dedek" },
        { time: 20, text: "Karna dedek selalu support apapun yang aku lakuin" },
        { time: 23, text: "Makasih juga udah nerima aku apa adanya" },
        { time: 30, text: "Meskipun aku belom bisa ngasih dedek apa apa" },
        { time: 33, text: "Aku happy karna aku bisa punya dedek dan disisi lain aku sedih karna aku belom bisa ngasih apa apa ke dedek" },
        { time: 37, text: "Makasih banyak dedek buat semuanya" },
        { time: 44, text: "I LOVE YOU SO MUCH" },
    ];
